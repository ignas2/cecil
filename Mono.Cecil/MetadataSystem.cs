...
namespace Mono.Cecil {
	...
	sealed class MetadataSystem {
		...
		internal Dictionary<uint, Row<MetadataToken, int> []> Interfaces;
		...
		public bool TryGetInterfaceMapping (TypeDefinition type, out Row<MetadataToken, int> [] mapping)
		{
			return Interfaces.TryGetValue (type.token.RID, out mapping);
		}

		public void SetInterfaceMapping (uint type_rid, Row<MetadataToken, int> [] mapping)
		{
